...
{
	[System.Serializable]
	public class StorableRectInt : StorableValue<RectInt>
	{
		/// <summary>
		...
		/// </summary>
		public override RectInt SavedValue { get { return PlayerPrefsExtensions.GetRectInt(Key, Value); } }

		// The default constructor is needed for the sake of Unity's serialization.
		protected StorableRectInt() { }
		/// <summary>
		...
		public StorableRectInt(string key) : this(key, default) { }
		/// <summary>
		/// Creates a storable value.
		/// </summary>
		/// <param name="key">The string identifier to store <see cref="StorableValue{T}.Value"/> in <see cref="PlayerPrefs"/>.</param>
		/// <param name="value">The value to be stored.</param>
		public StorableRectInt(string key, RectInt value) : this(key, value, g => g, s => s) { }
		/// <summary>
		/// Creates a storable value.
		/// </summary>
		/// <param name="key">The string identifier to store <see cref="StorableValue{T}.Value"/> in <see cref="PlayerPrefs"/>.</param>
		...
		public StorableRectInt(string key, RectInt value, System.Func<RectInt, RectInt> getterFunc, System.Func<RectInt, RectInt> setterFunc) : base(key, value, getterFunc, setterFunc) { }

		protected override void SaveValueToPlayerPrefs(RectInt value)
		{
			PlayerPrefsExtensions.SetRectInt(Key, value);
		}
	}
}